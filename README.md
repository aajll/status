...
5. **ISR-safe signalling** - Set status bits from interrupt context; only the `STATUS_USE_NO_ATOMICS` backend needs the critical-section hooks

## Notes

| Topic                 | Note                                                                                                                                                                                                                                                                                                                                    |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Memory**            | No heap use. The singleton registers are statically allocated; a `status_reg_t` is caller-allocated, either static or automatic                                                                                                                                                                                                         |
